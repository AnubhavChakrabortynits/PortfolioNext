...
export default function Projects() {
  return (
    ...
    <div className='lg:h-screen max-w-[1240px] mx-auto py-32 px-2'>
      ...
      <div className='grid md:grid-cols-2 gap-8'>
        ...
        <div className='hidden max-w-[200px] group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
          <h3 className='text-2xl font-bold tracking-wide text-center text-gray-50 uppercase'>Recipe Search Webapp</h3>
